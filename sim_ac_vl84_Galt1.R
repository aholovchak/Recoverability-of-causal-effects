# Simulation study for estimation of \theta_{84} under G_{alt1}
...
causal_loop <- foreach(
  ...
  source("sim_data_Galt1.R") # input simulated m-DAG
...
write.csv(data_ci_partial, "ac_Galt1.csv", row.names = FALSE)
