#' Estimation of \theta_{VL_84} under G_{alt1} based on multiple imputation
...
write.csv(results_imp, file = "results_imp_vl84_altern_2miss.csv")

# For Monte Carlo confidence intervals in Appendix D.3)
saveRDS(results_list, "mi_Galt1.rds")
